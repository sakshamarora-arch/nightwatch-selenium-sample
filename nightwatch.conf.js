module.exports = (function (settings) {
  ...
  console.log("Initial LT username:", settings.test_settings.default.username);
  ...
  // Selenium port override
  if (process.env.SELENIUM_PORT) {
    settings.selenium.port = Number(process.env.SELENIUM_PORT);
  }
  ...
  console.log("Final Nightwatch settings:", JSON.stringify(settings, null, 2));
